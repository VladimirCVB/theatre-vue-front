<template>
    <div class="p-10 bg-gray-400 rounded-lg shadow-xl" v-if="!register">
        <form>
            ...
            <button class="bg-blue-600 hover:bg-blue-800 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline my-4" type="button">Sign In</button>
